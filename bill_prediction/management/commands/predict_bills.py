...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        house_passed_df = df[df['status'].isin(HOUSE_PASS_STATUS_LIST)]
        ...
        house_failed_df = df[df['status'].isin(HOUSE_FAIL_STATUS_LIST)]
        ...
        senate_passed_df = df[df['status'].isin(SENATE_PASS_STATUS_LIST)]
        ...
        senate_failed_df = df[df['status'].isin(SENATE_FAIL_STATUS_LIST)]
