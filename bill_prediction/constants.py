...
HOUSE_XGB_MODEL_PATH = 'bill_prediction/outputs/models/house_xgb.json'
HOUSE_RF_MODEL_PATH = 'bill_prediction/outputs/models/house_logistic.joblib'
SENATE_XGB_MODEL_PATH = 'bill_prediction/outputs/models/senate_xgb.json'
SENATE_RF_MODEL_PATH = 'bill_prediction/outputs/models/senate_logistic.joblib'
PICKLE_MODEL_PATH = 'bill_prediction/outputs/models/house_logistic.joblib'
